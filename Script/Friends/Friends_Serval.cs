...
public class Friends_Serval : FriendsBase
{
    ...
    public override void AnimationStopTiming() {
        if (state == State.Attack && !isAnimEnd && !isAnimStopped) {
            ...
            switch (attackType) {
                case 4:
                    anim.Play(PlayerController.animStateHashJump, 0, PlayerController.animStopNormalizedTimeJump);
                    break;
                case 8:
                    anim.Play(PlayerController.animStateHashBolt, 0, PlayerController.animStopNormalizedTimeBolt);
                    break;
                case 5:
                    anim.Play(PlayerController.animStateHashPile, 0, PlayerController.animStopNormalizedTimePile);
                    break;
            }
        }
